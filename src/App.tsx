...
import { PrompotSelect } from "./components/prompt-select";
    ...
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="https://github.com/luc4sdev" target="_blank" rel="external">
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          <div className="grid grid-rows-2 gap-4 flex-1">
            <Textarea
              className="row-span-1 resize-none p-4 leading-relaxed"
        ...
        <aside className="w-80 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="space-y-2">
              <Label>Prompt</Label>
              <PrompotSelect onPromptSelected={setInput} />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select disabled defaultValue="gpt3.5">
                ...
                <SelectContent>
                  <SelectItem value="gpt3.5">GPT 4.0</SelectItem>
                </SelectContent>
              </Select>
            ...
            <Button disabled={isLoading} type="submit" className="w-full">Executar
