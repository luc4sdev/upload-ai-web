...
export function VideoInputForm({ onVideoUploaded } : VideoInputForm) {
    ...
    return (
        <form onSubmit={handleUploadVideo} className="space-y-3">
            ...
            <Button data-success={status === 'success'} disabled={status !== 'waiting'} type="submit" className="w-full data-[success=true]:bg-emerald-500">
                {status === 'waiting' ? (
                    <>
                        Carregar vídeo
